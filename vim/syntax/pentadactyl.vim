...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ aardvark ab[breviate] addo[ns] ao au[tocmd] ba[ck] background bg bd[elete]
    \ blistk[eys] blk bm[ap] bma[rk] bmarks bml-page2rss bml-readability
    \ bml-readable bml-share bml-subscribe bml-twitter bno[remap] bootstrap
    \ b[uffer] buffers files ls tabs bunm[ap] ca[bbreviate] cal caret
...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    ...
    \ passkeys pk passunknown pu popups pps previouspattern readability-style
